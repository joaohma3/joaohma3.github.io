<?php
    ...
    if(isset($_GET['cod']) && is_numeric($_GET['cod'])){
        ...
        $ret = $objDAO->CadastrarConta($banco, $agencia, $numero, $saldo, $idConta);
            ...
            <div id="page-inner">
                ...
                <form action="alterar_conta.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Digite o Nome Banco aqui..." name="banco" id="banco" value="<?= $dados[0]['banco_conta'] ?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Digite o Valor (R$) aqui..." name="saldo" id="saldo" value="<?= $dados[0]['saldo_conta'] ?>"/>
                    </div>
